...
/**
 * Service for interacting with the Core microservice.
 */
class CoreService extends AbstractHttpService
{
    /**
     * @inheritDoc
     */
    ...
    {
        return ServiceConfig::getServiceUrl(ServiceConfig::CORE_SERVICE_NAME);
    }
